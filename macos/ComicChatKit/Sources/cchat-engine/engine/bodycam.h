...
// R11: the entire CBodyCam widget is the interactive emotion-picker (CWnd
// subclass: paint/mouse/tooltip/context-menu handlers, GetBodyCam() singleton).
// It is UI/session layer, not part of the headless load/parse/draw path, and
// nothing in the lifted engine tree includes this header. The whole class
// declaration + GetBodyCam() extern are wrapped under CC_NO_UI (defined for
// this plan): none of it compiles headless. The CBody*/CBodyDouble/CBodySingle
// draw+bbox methods this task makes live are declared in avatar.h, NOT here.
#ifndef CC_NO_UI
